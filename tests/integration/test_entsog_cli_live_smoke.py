"""Live CLI smoke tests for ENTSO-G command paths."""
...
def _assert_outputs(paths: CliSmokePaths, dataset: str) -> None:
    bronze_root = paths.data_dir / "bronze" / "entsog" / dataset
    silver_root = paths.data_dir / "silver" / "entsog" / dataset
...
@pytest.mark.live
def test_live_pipeline_entsog_reference_dataset_creates_bronze_and_silver(
    tmp_path: Path,
