...
DOC_TYPES: dict[str, EntsoeDocType] = {
    ...
    "outages_consumption": EntsoeDocType(
        "A76",
        None,
        "Aggregated unavailability of consumption units",
        domain_style="bidding_zone",
        extra_params={"BusinessType": "A53"},
        optional_params=("DocStatus", "mRID", "PeriodStartUpdate", "PeriodEndUpdate"),
    ),
    "outages_transmission": EntsoeDocType(
        "A78",
        None,
    ...
    "outages_offshore_grid": EntsoeDocType(
        "A79",
        None,
        "Unavailability of offshore grid infrastructure",
        domain_style="bidding_zone",
        optional_params=("DocStatus", "mRID"),
    ),
    "outages_production": EntsoeDocType(
        "A77",
        None,
