"""Silver transformer for Elexon Bid/Offer Data (BOD)."""
...
class BODTransformer(BaseSilverTransformer):
    """Transform Elexon BOD data from bronze to silver."""
    ...
    def transform(self, raw_df: pl.DataFrame) -> pl.DataFrame:
        ...
        column_mapping = {
            ...
            "bmUnit": "bm_unit_id",
            "bidOfferPairNumber": "bid_offer_pair_number",
        ...
        if missing:
            logger.error(f"Missing required columns in BOD: {missing}")
            return pl.DataFrame()
        ...
        dedup_cols = ["settlement_date", "settlement_period", "bm_unit_id"]
        if "bid_offer_pair_number" in df.columns:
            dedup_cols.append("bid_offer_pair_number")
        ...
        output_cols = [
            ...
            "bm_unit_id", "bid_offer_pair_number",
...
register_transformer("elexon", "bod", BODTransformer)
